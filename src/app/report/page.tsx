...
const reportSubNavItems = ["Standard Reports", "Custom Reports", "Scheduled Reports"];

const ReportPage: NextPage = () => {
  const [activeSubNav, setActiveSubNav] = useState<string>(reportSubNavItems[0]);
        ...
        <Card className="w-full max-w-lg shadow">
          ...
          <CardContent>
            <p className="text-center text-muted-foreground">
              Content for the Reports section is not yet implemented.
            </p>
          </CardContent>
        </Card>
      </main>
